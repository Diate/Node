...
exports.logout = exports.loginfuc = void 0;
...
var loginfuc = exports.loginfuc = /*#__PURE__*/function () {
  ...
  return function loginfuc(_x, _x2) {
...
var loginbtn = document.querySelector('.nav__el--logout');
...
if (loginform) {
  loginform.addEventListener('submit', function (e) {
    ...
    e.preventDefault();
    (0, _login.loginfuc)(email, password);
  });
}
if (loginbtn) loginbtn.addEventListener('click', _login.logout);
